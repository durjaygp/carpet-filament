                ...
                <div class="row-demo">
                    ...
                    <div class="demo-item">
                        <a href="home-furniture#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-furniture.jpg" src="{{asset('assets')}}/images/demo/home-furniture.jpg" alt="home-furniture">
                            </div>
                            <span class="demo-name">Home Furniture</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-furniture-02#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-furniture2.jpg" src="{{asset('assets')}}/images/demo/home-furniture2.jpg" alt="home-furniture-2">
                            </div>
                            <span class="demo-name">Home Furniture 2</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-skateboard#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-skateboard.jpg" src="{{asset('assets')}}/images/demo/home-skateboard.jpg" alt="home-skateboard">
                            </div>
                            <span class="demo-name">Home Skateboard</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-stroller#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-stroller.jpg" src="{{asset('assets')}}/images/demo/home-stroller.jpg" alt="home-stroller">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-decor#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-decor.jpg" src="{{asset('assets')}}/images/demo/home-decor.jpg" alt="home-decor">
                            </div>
                            <span class="demo-name">Home Decor</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-electronic#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-electronic.jpg" src="{{asset('assets')}}/images/demo/home-electronic.jpg" alt="home-electronic">
                            </div>
                            <span class="demo-name">Home Electronic</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-setup-gear#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-setup-gear.jpg" src="{{asset('assets')}}/images/demo/home-setup-gear.jpg" alt="home-setup-gear">
                            </div>
                            <span class="demo-name">Home Setup Gear</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-dog-accessories#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-dog-accessories.jpg" src="{{asset('assets')}}/images/demo/home-dog-accessories.jpg" alt="home-dog-accessories">
                            </div>
                            <span class="demo-name">Home Dog Accessories</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-kitchen-wear#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-kitchen.jpg" src="{{asset('assets')}}/images/demo/home-kitchen.jpg" alt="home-kitchen-wear">
                            </div>
                            <span class="demo-name">Home Kitchen Wear</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-phonecase#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-phonecase.jpg" src="{{asset('assets')}}/images/demo/home-phonecase.jpg" alt="home-phonecase">
                            </div>
                            <span class="demo-name">Home Phonecase</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-paddle-boards#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home_paddle_board.jpg" src="{{asset('assets')}}/images/demo/home_paddle_board.jpg" alt="home-paddle_board">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-glasses#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-glasses.jpg" src="{{asset('assets')}}/images/demo/home-glasses.jpg" alt="home-glasses">
                            </div>
                            <span class="demo-name">Home Glasses</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-pod-store#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-pod-store.jpg" src="{{asset('assets')}}/images/demo/home-pod-store.jpg" alt="home-pod-store">
                            </div>
                            <span class="demo-name">Home POD Store</span>
                        </a>
                    </div>
                    <div class="demo-item">
                        <a href="home-activewear#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-activewear.jpg" src="{{asset('assets')}}/images/demo/home-activewear.jpg" alt="home-activewear">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-handbag#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-handbag.jpg" src="{{asset('assets')}}/images/demo/home-handbag.jpg" alt="home-handbag">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-tee#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-tee.jpg" src="{{asset('assets')}}/images/demo/home-tee.jpg" alt="home-tee">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-sock#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-socks.jpg" src="{{asset('assets')}}/images/demo/home-socks.jpg" alt="home-sock">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-jewerly#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-jewelry.jpg" src="{{asset('assets')}}/images/demo/home-jewelry.jpg" alt="home-jewelry">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-sneaker.jpg" src="{{asset('assets')}}/images/demo/home-sneaker.jpg" alt="home-sneaker">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-accessories#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-accessories.jpg" src="{{asset('assets')}}/images/demo/home-accessories.jpg" alt="home-accessories">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-grocery#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-gocery.jpg" src="{{asset('assets')}}/images/demo/home-gocery.jpg" alt="home-grocery">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-baby#">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('assets')}}/images/demo/home-baby.jpg" src="{{asset('assets')}}/images/demo/home-baby.jpg" alt="home-baby">
                            </div>
    ...
    <div class="mb-canvas-content">
        <div class="mb-body">
            <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                ...
                <li class="nav-mb-item">
                    <a href="#" class="item-link">Reviews</a>
                </li>
                <li class="nav-mb-item">
                ...
                <li class="nav-mb-item">
                    <a href="#" class="item-link">SPECIAL</a>
                </li>
                <li class="nav-mb-item">
            ...
            <div class="mb-other-content">
                <div class="d-flex group-icon">
                    ...
                    <a href="home-search#" class="site-nav-icon"><i class="icon icon-search"></i>Search</a>
                </div>
                <div class="mb-notice">
                    ...
                    <div class="tf-col-quicklink">
                        <ul class="tf-quicklink-list">
                            <li class="tf-quicklink-item">
                                <a href="#" class="">Kids Rugs</a>
                            </li>
                            <li class="tf-quicklink-item">
                                <a href="#" class="">Carpet Tiles</a>
                            </li>
                            <li class="tf-quicklink-item">
                                <a href="#" class="">Boat Carpet</a>
                            </li>
...
<div class="offcanvas offcanvas-start canvas-mb toolbar-shop-mobile" id="toolbarShopmb">
    ...
    <div class="mb-canvas-content">
        <div class="mb-body">
            <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                ...
                <li class="nav-mb-item">
                    <a href="#" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{asset('assets')}}/images/shop/cate/cate2.jpg" alt="">
                        </div>
                        <span>Dog</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="#" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{asset('assets')}}/images/shop/cate/cate3.jpg" alt="">
                        </div>
                        <span>Grocery</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="#" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{asset('assets')}}/images/shop/cate/cate4.png" alt="">
                        </div>
                        <span>Handbag</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
                        <div class="image">
                            <img src="{{asset('assets')}}/images/shop/cate/cate5.jpg" alt="">
                        </div>
                        <span>Fashion</span>
                                ...
                                <div id="cate-shop-one" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        ...
                                        <li>
                                            <a href="#" class="tf-category-link sub-nav-link">
                                                <div class="image">
                                                    <img src="{{asset('assets')}}/images/shop/cate/cate8.jpg" alt="">
                                                </div>
                                                <span>Shoes</span>
                                            </a>
                                        </li>
        ...
        <div class="mb-bottom">
            <a href="#" class="tf-btn fw-5 btn-line">View all collection<i class="icon icon-arrow1-top-left"></i></a>
        </div>
    </div>
</div>
<!-- /toolbarShopmb -->
                            ...
                            <div class="tf-mini-cart-items">
                                <div class="tf-mini-cart-item">
                                    <div class="tf-mini-cart-image">
                                        <a href="#">
                                            <img src="{{asset('assets')}}/img/1.webp" alt="">
                                        </a>
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <a class="title link" href="#">Carpet 01</a>
                                ...
                                <div class="tf-mini-cart-item">
                                    <div class="tf-mini-cart-image">
                                        <a href="#">
                                            <img src="{{asset('assets')}}/img/2.webp" alt="">
                                        </a>
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <a class="title link" href="#">Carpet 02</a>
                                        <div class="price fw-6">$25.00</div>
                                        <div class="tf-mini-cart-btns">
                                            <div class="wg-quantity small">
                                                <span class="btn-quantity minus-btn">-</span>
                                    ...
                                    <div class="swiper-wrapper" >
                                        <div class="swiper-slide">
                                            <div class="tf-minicart-recommendations-item">
                                                <div class="tf-minicart-recommendations-item-image">
                                                    <a href="#">
                                                        <img src="{{asset('assets')}}/img/3.webp" alt="">
                                                    </a>
                                                </div>
                                                <div class="tf-minicart-recommendations-item-infos flex-grow-1">
                                                    <a class="title" href="#">Carpet 03</a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-minicart-recommendations-item">
                                                <div class="tf-minicart-recommendations-item-image">
                                                    <a href="#">
                                                        <img src="{{asset('assets')}}/img/5.webp" alt="">
                                                    </a>
                                                </div>
                                                <div class="tf-minicart-recommendations-item-infos flex-grow-1">
                                                    <a class="title" href="#">Carpet 04</a>
                                                    <div class="price">$25.00</div>
                                                </div>
                                                <div class="tf-minicart-recommendations-item-quickview">
                                                    <div class="btn-show-quickview quickview hover-tooltip">
                    ...
                    <div class="tf-mini-cart-bottom">
                        ...
                        <div class="tf-mini-cart-bottom-wrap">
                            ...
                            <div class="tf-mini-cart-view-checkout">
                                <a href="view-cart#" class="tf-btn btn-outline radius-3 link w-100 justify-content-center">View cart</a>
                            ...
                            <div class="tf-compare-offcanvas">
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="#">
                                            <img class="radius-3" src="{{asset('assets')}}/images/products/orange-1.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="#">
                                            <img class="radius-3" src="{{asset('assets')}}/images/products/pink-1.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="tf-rte">
                ...
                <div class="tf-page-size-chart-content">
                    ...
                    <div>
                        <img class="sizechart lazyload" data-src="{{asset('assets')}}/images/shop/products/size_chart2.jpg" src="{{asset('assets')}}/images/shop/products/size_chart2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
