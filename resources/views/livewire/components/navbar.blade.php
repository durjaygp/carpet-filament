                ...
                <div class="row wrapper-header align-items-center">
                    <div class="col-xl-5 tf-md-hidden">
                        <ul class="header-list-categories">
                            <li class="categories-item active"><a href="#" class="text-uppercase">Kids Rugs</a></li>
                            <li class="categories-item"><a href="#" class="text-uppercase">Carpet Tiles</a></li>
                            <li class="categories-item"><a href="#" class="text-uppercase">Boat Carpet</a></li>
                        </ul>
                    </div>
                ...
                <div class="wrapper-header d-flex justify-content-center align-items-center">
                    <nav class="box-navigation text-center">
                        <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                            <li class="menu-item">
{{--                                <a wire:click="$emit('navigate', 'home')" class="item-link">Home </a>--}}
{{--                                <a x-data @click="$wire.$emit('navigate', 'home')" class="item-link">Home</a>--}}
                                <a class="item-link" href="/" wire:navigate>Home</a>

                            </li>
                            <li class="menu-item">
                                <a class="item-link" href="/about" wire:navigate>About</a>


                                {{--                                <a wire:click="$emit('navigate', 'about')" class="item-link">Who We Are </a>--}}
{{--                                <a x-data @click="$wire.$emit('navigate', 'about')" class="item-link">Who We Are</a>--}}
                            </li>
                            <li class="menu-item">
